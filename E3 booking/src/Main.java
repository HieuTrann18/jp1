...
public class Main {
    public static void main(String[] args) {
        ...
        rooms.add(new Room(4, "RS002", RoomType.SINGLE, 8));
        rooms.add(new Room(5, "RS003", RoomType.SINGLE, 8));
        rooms.add(new Room(6, "RS004", RoomType.SINGLE, 8));
        ...
        BookingService bookingService = new BookingService(customers, rooms ,bookings);
